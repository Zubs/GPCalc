...
.forgot-link { font-size: 0.8rem; color: var(--text-muted); transition: color 0.15s; }
...
.divider-text { font-size: 0.78rem; color: var(--text-muted); flex-shrink: 0; }

.demo-btn { font-size: 0.85rem; }
