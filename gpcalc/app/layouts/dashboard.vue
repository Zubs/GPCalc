...
.sidebar-close { display: none; background: none; border: none; color: var(--text-muted); font-size: 1rem; }
...
.nav-item {
  ...
  padding: 9px 12px; font-size: 0.88rem; font-weight: 400;
  color: var(--text-secondary); border-radius: var(--radius-md);
  transition: all 0.15s;
}
.nav-item:hover { color: var(--text-primary); background: var(--bg-elevated); }
.nav-item.active { color: var(--text-primary); background: var(--bg-elevated); font-weight: 500; }
...
.mobile-menu-btn { display: none; background: none; border: none; color: var(--text-secondary); }
.topbar-breadcrumb { flex: 1; }
.breadcrumb-page { font-size: 0.88rem; font-weight: 500; color: var(--text-primary); }
...
.cgpa-chip strong { color: var(--amber-400); font-weight: 600; }

.dash-content { flex: 1; padding: 28px 28px 48px; max-width: 1100px; width: 100%; margin: 0 auto; }
