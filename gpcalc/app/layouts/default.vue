      ...
      <Transition name="mobile-nav">
        <div v-if="mobileOpen" class="mobile-nav">
          ...
          <div class="mobile-actions">
            ...
            <NuxtLink to="/register" class="btn btn-primary btn-full" @click="mobileOpen=false">Get started free</NuxtLink>
          </div>
        </div>
      </Transition>
    </header>
...
<style scoped>
.layout-default { display: flex; flex-direction: column; min-height: 100vh; }
...
.light .site-header.scrolled { background: rgba(244,246,251,0.88); }
...
.mobile-link:hover { color: var(--text-primary); background: var(--bg-elevated); }
.mobile-actions { display: flex; flex-direction: column; gap: 8px; margin-top: 12px; padding-top: 12px; border-top: 1px solid var(--border); }

.mobile-nav-enter-active, .mobile-nav-leave-active { transition: all 0.2s var(--ease); }
...
.footer-tagline { margin-top: 8px; font-size: 0.85rem; color: var(--text-muted); }
.footer-links { display: flex; gap: 48px; }
.footer-col { display: flex; flex-direction: column; gap: 10px; }
.footer-col-title { font-size: 0.78rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em; color: var(--text-muted); }
.footer-col a { font-size: 0.88rem; color: var(--text-secondary); transition: color 0.15s; }
